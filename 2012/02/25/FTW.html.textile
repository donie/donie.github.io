...
<h4> <a href="/2012/02/25/FTW.html"> FTW </a> </h4>
p. 好吧， -抛开那些所谓梦想与迷失的话题。- 作为一个伪文青不思考这个不太现实。

p. 梦想你到底是什么东西，快点，快点，最起码让俺看到你是个什么样，好不好？  -哪怕不能实现- ，wait，证明梦想不能实现就好像证明xx系统不存在漏洞似的，只能证明它是可以实现的，对吧，开复老师？

p. I need the red pill.

bq. 最近 twitter TL 上受到微博的 _反射_ 越来越深，没错，说的就是那些同时使用微博和 twitter 并类此不疲的在两边转发段子的同学们。 
